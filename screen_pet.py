...
pupil_righht = c.create_oval (240, 145, 250, 155, outline='black',fill='black')
...
def hide_happy (event):
    c.itesconfigure(cheek_left, state=HIDDEN)
    c.itemconfigure(cheek_right, state=HIDDEN)
    c.itemconfigure (mouth_happy, state=HIDDEN)
    c.itesconfigure (mouth_normal, state=NORMAL)
    c.itemconfigure (mouth_sad, state=HIDDEN)
